...
export interface Citation{citation_id:string;document_id:string;file_name:string;location_type:string;location_number:number;excerpt:string;relevance_score:number}
export interface ChatRequest{message:string;document_ids:string[];filters:Filters;conversation_id:string|null;history:ChatMessage[]}
export interface ChatResponse{answer:string;citations:Citation[];retrieved_chunk_count:number;missing_information:string[];conversation_id:string}
